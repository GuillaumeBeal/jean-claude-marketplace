# Paramètres de search_texts

## Fonds de recherche

| Valeur | Description |
|--------|-------------|
| `ALL` | Tous les fonds (recherche large — éviter si possible) |
...
| `JUFI` | Jurisprudence de première instance |
...
| `NUM_TEXTE` | Numéro du texte |

## Filtre de date par fond — RÉFÉRENCE OBLIGATOIRE
...
```json
{"facette": "DATE_PUBLICATION", "dates": {"start": "2024-01-01", "end": "2026-04-06"}}
```
...
{"facette": "DATE_PUBLICATION", "dates": {"start": "2024-01-01", "end": "2026-04-06"}}
{"facette": "DATE_SIGNATURE", "dates": {"start": "2024-01-01", "end": "2026-04-06"}}
...
### JURI
```json
{"facette": "DATE_DECISION", "dates": {"start": "2024-01-01", "end": "2026-04-06"}}
...
### CNIL
```json
{"facette": "DATE_DELIB", "dates": {"start": "2024-01-01", "end": "2026-04-06"}}
...
```json
{"facette": "DATE_SIGNATURE", "dates": {"start": "2024-01-01", "end": "2026-04-06"}}
{"facette": "DATE_DIFFUSION", "dates": {"start": "2024-01-01", "end": "2026-04-06"}}
{"facette": "IDCC", "valeurs": ["1486"]}
```
